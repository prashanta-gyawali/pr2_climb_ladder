...
if __name__ == '__main__':
	...
	rung1_sub = message_filters.Subscriber('Centroid_Rung1_Odom_Frame', PointStamped)
	rung2_sub = message_filters.Subscriber('Centroid_Rung2_Odom_Frame', PointStamped)
